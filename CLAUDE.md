...
dist/hisab.cyr       — full 35-module distlib bundle (832,590 B / 21,964 lines),
...
- **Toolchain pin**: `cyrius = "6.5.17"` in `cyrius.cyml`. CI and release both grep
