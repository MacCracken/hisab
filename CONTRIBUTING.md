...
- [Cyrius](https://github.com/MacCracken/cyrius), at whatever version `cyrius.cyml [package].cyrius` pins — 6.5.17 as of the 2.10.0 line. CI greps the manifest rather than carrying a literal; match the manifest and don't hardcode a version elsewhere
