...
- [Cyrius](https://github.com/MacCracken/cyrius), at whatever version `cyrius.cyml [package].cyrius` pins — 6.5.33 as of 2.11.2. CI greps the manifest rather than carrying a literal; match the manifest and don't hardcode a version elsewhere
...
# Run all five suites (3526 assertions). CI runs every tests/*.tcyr — running
