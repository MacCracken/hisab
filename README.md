...
tag     = "2.6.13"
modules = ["dist/hisab.cyr"]   # ~562 KB self-contained bundle (all 34 modules)
...
cyrius test tests/hisab.tcyr        # 200 smoke tests
cyrius test tests/foundation.tcyr   # 307 foundation tests
cyrius test tests/modules.tcyr      # 369 module tests
cyrius test tests/edge_cases.tcyr   # 187 edge case tests
...
| Tests | 1063 assertions across 4 suites |
