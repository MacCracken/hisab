...
> **Last refresh**: 2026-05-29 (v2.6.1). Scaffolded at v2.4.6 during the post-2.4.x
...
> (Weyl tensor). Suite 901 → 939. README / CLAUDE / testing / roadmap counts synced
...
## At a glance — inventory (last reviewed 2026-05-29, v2.6.1)
