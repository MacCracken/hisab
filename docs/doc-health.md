...
| File | Last touched | Status | Action |
|---|---|---|---|
| `testing.md` | 2026-08-09 | ✅ Fresh | **v2.9.2**: suite counts → 416/349/1621/233/**732** (**3351** total across **five** suites — `abuse.tcyr` was absent from both the recipe and the table), benchmarks 28 → **55**. **Still owes the test-quality revision** carried since 2.7.0. |
