...
> **Last refresh**: 2026-05-29 (v2.4.6). Scaffolded during the post-2.4.x doc
> sweep, then a same-day **verify-and-cleanup pass**: re-ran `bench-history.sh`
...
## At a glance — inventory (last reviewed 2026-05-29, v2.4.6 verify pass)
...
| File | Last touched | Status | Action |
|---|---|---|---|
| `roadmap.md` | 2026-05-29 | ✅ Fresh | **Rotates every release.** Pruned to forward-facing only (completed arcs → Release History). Open: 2.5.0 (CGA + `mat_new` guard), 2.6.0 (diffgeo), 2.7.0 (rendering/GPU/reverse-AD), 3.0.0 (`Result<T,E>`), + Parked. |
