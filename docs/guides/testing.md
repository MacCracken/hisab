...
```bash
# All test suites
cyrius test tests/hisab.tcyr        # 497 smoke/integration tests
cyrius test tests/foundation.tcyr   # 413 exhaustive foundation type tests
cyrius test tests/modules.tcyr      # 2072 per-module tests
