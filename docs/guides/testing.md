...
```bash
# All test suites
cyrius test tests/hisab.tcyr        # 152 smoke/integration tests
...
| `hisab.tcyr` | 152 | Cross-module integration — ODE, optimization, sparse, PGS/LCP, ray-sphere, Newton, Euler identity, CGA (contraction/dual/projection), mat_new_guarded, sectional curvature |
