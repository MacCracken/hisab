...
```bash
# All test suites
cyrius test tests/hisab.tcyr        # 143 smoke/integration tests
...
| `hisab.tcyr` | 143 | Cross-module integration — ODE, optimization, sparse, PGS/LCP, ray-sphere, Newton, Euler identity, CGA contraction + dual + projection |
